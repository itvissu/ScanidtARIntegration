...
import { PrivateQuadrilateral, Quadrilateral } from 'Common';
...
export class Barcode {
  ...
  private static fromJSON(json: any): Barcode {
...
export class LocalizedOnlyBarcode {
  ...
  private static fromJSON(json: any): LocalizedOnlyBarcode {
    const session = new LocalizedOnlyBarcode();
    session._location = (Quadrilateral as any as PrivateQuadrilateral).fromJSON(json.location);
    session._frameID = json.frameId;
    return session;
  }
}
