...
kotlinClasspath = ' \t\tclasspath "org.jetbrains.kotlin:kotlin-gradle-plugin:$kotlin_version"'
...
const addKotlinSupport = (context) => {
    ...
    if (kotlinVersion) {
        ...
        gradleFileContent = append(kotlinClasspath, kotlinClasspathPositionRegex, gradleFileContent)
    }
